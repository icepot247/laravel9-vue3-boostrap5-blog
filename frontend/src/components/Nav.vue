  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg mb-4 border-bottom">
      <router-link :to="routes[0].path" class="navbar-brand d-flex align-items-center text-decoration-none">
        ...
        <sup><small class="badge rounded-pill bg-info me-1">3</small></sup>
        ...
        <sup><small class="badge rounded-pill bg-info me-1">5</small></sup>
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item text-uppercase" v-for="route in routes" :key="route.path">
            <router-link :to="route.path" class="nav-link" :title="route.children[0].name" v-if="route.visable"
